...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/j7RlD5l5q1w64RYdWGzQqfvh23KnxRoeDyDTCQAdiboW3MWt5ClaAibokj04j5jJ3JmTXXWAqPkt9eTNpUPWeiabA4iaCK9FR0cRHGuayBw7PXk/640?wx_fmt=jpeg&from=appmsg&wxfrom=13&tp=wxpic#imgIndex=0)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1zpia0rcCBEN4QqL2MgnesZenpV04h5qYObIcCDF7loOPqnkZErsJGBtF9Rb9gDHoaRLPYNYYnxF5q8XsyGQg4lucQma2SWtCeM/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=1)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1wToveaVX2YnQcBt0oTsy1UmK7ek2TBZ49BS23qjkV1YCkjVBH8icfRiaT5wseyJU2hDo4EFW41wlfqkUnOuYM5Nicib8bsOeuKxxI/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=2)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/j7RlD5l5q1yCic38VIR7B3lHd1ibkdQJ4JsBbibbFvT0B5GBYIgMmhMJrwzYoGn7YuUZBQIl96lZJwicjYsQMYCmFpIy8RdibHMG79FmHqibbR3yE/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=3)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/j7RlD5l5q1zW5vGkSgXJicIPN04QOcr6QR5Qy1raByyufIpKXPWEibc5F5qDszMuDsSNZGfj4Uyqh7xC2cDibmYIvGMLPcBO0O3viccSzcxDP68/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=6)
...
- ![](https://wx.qlogo.cn/mmopen/j7RlD5l5q1x4uAsC94gBtBPRr8ZFPRmuOVm25ujNdnrkoBMyoicC3ULnVcVklxgnxCzqmsQJzj9yvXicl7HZ1035a45UcMMmiabfOk2LxsPdkwNwBIPBPYz3lH2l4NicZJWg/64)
    ...
    按照这个架构模式实际场景执行，加上人工review和fix的时间，是否会比纯spec模式耗时更多，操作起来更为复杂？
    
- ![](https://wx.qlogo.cn/mmopen/34Oy4kEEVxdHJzLOyst4dH9dJP8j7iaoib049wpRyc5NsKSQmLMNkzqJStYWRqOkqkaPJKrO8y6xFbqt695Dn9UzXQaDX2IYlp/64)
    ...
    Harness理念说白了就是：传统软件工程化思想与AI的完美结合
    
- ![](https://wx.qlogo.cn/mmopen/j7RlD5l5q1yB6KV97E60IdiajTARg7XB6sFRpqVjoX5ubsnwAhaPJyGbB8riaIoHUHUGmaGibvK1zeGeSZtHtIvXbjU9JPf1SjDHbuUnHV7HvX9HrlDUyibn1NvhVkovWsvC/64)
    ...
    请问 .harness 文件夹下的内容是如何被 AI Coding 工具识别的呢，比如使用 Claude Code 编码的时候，它不会去读 .harness 文件夹
    
- ![](https://wx.qlogo.cn/mmopen/j7RlD5l5q1xHlTagvTBmbDp5vDia7MZMuUs8GuvPawbM6B4ES9c7ZBpvpIabiajTibInviarqXHeDVJyOO3xbxpQxKXl0uXg3pUoEda4GmEHVeVh4PbYwJbHYcicHD7ec1nzN/64)
    ...
    有下面几个疑问麻烦解答下：1. 使用技能需求分析，评审的过程中会查询Wiki知识库+Rules生成功能级-详细设计还是伪代码设计？
    
    2. Wiki系统知识内容是架构设计人工写还是使用特定技能根据现有工程生成的？
    
    3. 技能需求分析，评审的最终结果会反向补充Wiki知识库?    
    
- ![](https://wx.qlogo.cn/mmopen/ajNVdqHZLLDWrUQic6qKDx10VP6O64ByXou7dg5scfib3us7wib1v6J0F2ia6ias3EPPlVLzUviaibiaYeoddoK5SgRuQut4DSgwAsiaibNibvpsPnaGLIibrpicQ9icqFP4rj2oWo6MCkfHk5SgiamFSg/64)
    ...
    博主思路很清晰![[强]](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=)。请教下，Ai Coding 相关的数据采集，比如采纳率等，是自研处理的呢还是基于开源框架。
    
- ![](https://wx.qlogo.cn/mmopen/j7RlD5l5q1yyv6jY4AXibeHwibcc3Pb7mMnkVIfOq4hejMVZfKHs4PK1fXciarBqvogLkvFh2uh8tCkVpLurSEIrSUW4lyOU4kfdANiaLHcgfzJf1xU17ibgI7OrQGrcX1BVU/64)
    ...
    ![](https://wx.qlogo.cn/mmopen/34Oy4kEEVxeiatrfPTHd0XK2vD3UY0nWTibHXDIOYCdFcrrquRKhlF5O6grhIe6G6pk1NtiaATjavMjgneKicWibPqWVsHzYAgx24/64)
    ...
    https://github.com/xujx1/dev-workflow
    
- ![](https://wx.qlogo.cn/mmopen/PwRZfCoFTib7BQaZWjlc4jKfhRRym86ibL2EN46VscER4RklMr86RDVmcVn8Hpp0ylakM69WRGGiaLeibtRf5EmCzdtF8mHx974J6bDsANNBxibWI17yF77xoIF4R03n52yXf/64)
    ...
    请问这套设计目前是全自动化推进的吗。工作流应该如何，是通过程序控制还是agent来灵活把控的呢
    
- ![](https://wx.qlogo.cn/mmopen/Q3auHgzwzM6tiavuB1AZL5Gu1cCErESk5DpW9lKMZY5QSkrp4tNbcBTdf8FBiaDn9WyU0u9yzSSY8LvSUvgy7Zdak8zH4jjY92e3ON2r8qEg1htoIXJ1UHuR4rhzMSenIv/64)
    ...
    棒！很好的实现了openai的harness-engineering
    
    不过anthropic的“long-running”里沙箱、持久化记忆、自主进化这些点应该是Effective harnesses for long-running agents的最终目标吧
