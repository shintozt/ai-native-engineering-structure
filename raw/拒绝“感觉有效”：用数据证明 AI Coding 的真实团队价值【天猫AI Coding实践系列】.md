...
![图片](https://mmbiz.qpic.cn/mmbiz_png/33P2FdAnju8PWonAvnSfAGMpeE3YoiaMheQKuLem4UiaZ7XfZBWlxAE6V7h1gWKibiaTgJFYhic2cK9icSpiaS9raEyOA/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&tp=wxpic#imgIndex=2)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp3qbcdQibGx0riaGd0LicdtuhmYbaOlUxkAUVnXMVo1w22jcUza44lAyqhGdnAnzCnoYezCPv1yHIhsxbGIOvHlLGctjohv8xxagA/640?from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=3)

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp2rbibagXjLQT4spq2GK4OQrIj5kkcgCRb7kIhhoDcRR4AiabuwaP6CQnCyBiahfHP7Du38Uqlw4IrKm9MqxlN1N96FzKEdwA4rC0/640?from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=4)

  

下钻到具体用例，可以看到得分差异背后的原因：

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp36Q1R9iaxTfTOOZ9cG4s9G2CiaR7ZCNcGXfxdkvuxG7Pw97RBLDucI3MXxeb4ibVc6NzS8xQN9JpU92VcaCyicfsLxn5pr2o2qLJs/640?from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=5)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp1h4NpBL0uFS5NdPf8jIcdAMH3wXbibzXkvPNO1iccZ2q607HlfpXab5XKa9Y1KTpEDPQm93Nwbcwa6icxy6FDAtNYxxO2qVtl9FI/640?from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=6)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp3g1nwErG0qY8DHRrggudvU7vwGArqDX1LBU7AMQzSBia7CTbqviaiaiaZOlAXIGE2iakVE5ug4rXMxR0Ly7XTAnwtAGRcCASvTHoyk/640?from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=7)

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp3H5dhDAWAo4reMwonYOm2cZPDdl3gf8WZdbLD9qBYujQhQP2QgVkXXYM0lnXeRdbROerGyQnGA6Ljw0cicOlWicPFDDoKfF4RmM/640?from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=8)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp1emnOZEdds4SGAL8ictXicj5AW0ncNa2TfwGEY3wJwvq8C1lkHYziaJSulRiaVvnlhKX8UdOC22obRUjCzlcuW3F8EgFGuia6vVzEg/640?from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=9)

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp2F3W6JoS5nBLJDZOMRAw5k85BFD832327Go9ju2lGyjSmZ33rR5qyPNZWobB1D5eTbXWa0UUTpCDUTRXhW6Hia0OJRicOlhk12Y/640?from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=10)
...
|   |   |   |
|---|---|---|
|组成部分|SWE-bench|垂直化评测基准|
|评测数据集|2294 个 GitHub Issue（Python 后端）|真实历史需求（针对特定业务场景）|
|评测方法|测试通过即正确（二元判定）|复杂度矩阵 + 量化评分（结果分 + 行为分）|
|评测工具|测试执行框架|LLM as Judge + 代码采纳率计算|

![图片](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp3ocHwl0ngtfA2kWavic73ic9EZ9zpxbJmDCOThXX2UXnTbVX7x244Uuoyvib1dbMN4V4304B6N8TUOSDBAK9T8hrQm2ayc1jdLgw/640?from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=12)

  

下图是评测数据集的部分用例：  

![图片](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp2RjnZoJwLvKLAskmD8Dta17g4AicBXvum2ibZGwkWicTKAE0icdE3AMjH7p7Oc9neB9CGWm2DibH6qODyu2libHt2GdOVtBchqHjWmk/640?from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=13)
...
|---|---|---|
|技术栈|可能的维度一|可能的维度二|
|中后台前端|业务复杂度（CRUD/联动/复杂交互）|组件成熟度（文档完善/部分/缺失）|
|后端服务开发|框架熟悉度（主流框架/小众框架/自研框架）|业务逻辑复杂度（单表/多表关联/分布式事务）|
|数据开发|数据规模（小数据量/中等/大规模）|处理逻辑复杂度（简单ETL/多源聚合/实时流处理）|
|配置生成|配置类型（标准配置/业务定制/平台特有）|依赖复杂度（无依赖/少量依赖/复杂依赖链）|
...
|---|---|---|---|
|层级|代号|典型场景|特征|
|标准化|L1|CRUD 列表、简单表单（≤15 字段）、详情展示页、简单配置页|直接使用组件库，逻辑简单，无复杂状态管理|
|有联动|L2|表单联动、多级筛选（省市区/类目树）、复杂表格（合并单元格、行内编辑）、审批流转|组件间有依赖关系，需要处理状态联动和数据转换|
|复杂交互|L3|拖拽排序、画布类、虚拟滚动、富文本定制、微前端集成|超出常规组件库覆盖范围，需要深度定制或架构级改造|
...
|---|---|---|---|
|层级|代号|定义|判断标准|
|完善|C1|组件存在且文档完善|组件在物料库中存在，有完整的 API 文档、使用示例、最佳实践|
|部分|C2|组件存在但文档不完善|组件存在但缺少使用示例，或文档过时，或缺少特定场景的指导|
|缺失|C3|需要自定义组件|物料库中无对应组件，需要从零开发或深度改造现有组件|
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp1vicICvvB1fILJq1rbzn7AXRgZroIlDOpj5Ana4icY2h9M6bZ2Ulesrq18nhASeIP8mbp8FIRGeR16niaVNXYOGIuQiaT2cUIDufQ/640?from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=14)
...
|---|---|---|
|视角|评判内容|权重|
|结果分|代码是否满足业务需求（refAnswers + testCases）|75%|
|行为分|Agent 是否遵循合理工作流程（知识库调用 + 文档查阅）|25%|

![图片](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp2uOdloiakvqHibIkCWM8JSGWekI0pEdiaGtpSZvTpyv4gvwUpn8yLwfkRKYIQtBaUZArCUWzh0JYn4AcAichys3QrzcHYicjjQjhgs/640?from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=15)
...
|---|---|---|---|---|
|用例|结果分|行为分|综合得分|分析|
|eval-001|1.0|1.0|0.94|理想情况：代码正确，且查阅了文档|
|eval-002|1.0|0.0|0.75|碰巧正确：代码正确，但没查任何资料|
|eval-003|0.5|1.0|0.63|认真但有误：查了资料，但实现有问题|
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp2EUo6G2kL5GgGrIN0MKeUt3LkKXsNtKOlniaGaN7BPNyiaZ94xqDMhtLmaO8gcs4YxDNqTKpHibhOaWvWn9EEjoZZobL0KvI1aeg/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=16)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp01pN441VgEsCGX56BTBibN2gA8YIoVGOfK9SeJUvicUCpLCibjHcfAsXa4bRQc2r9fJyz6tfRxiaLCAIibgoISbAQjNzkt5eakVLmc/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=17)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/33P2FdAnju8PWonAvnSfAGMpeE3YoiaMhAKxzUDHXniaXwPEesvQm9ore8gcW76d2WaReb3GPBX0SQ57suvSwAYw/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=18)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp2oXdibg0pBfEfW4ibuLF3ibmoHZ5QPeKv8wBcroYicjqhWx2Kh911Flt36ickm7zKB8zNvAEU05ZngPmQ9QyeibILgTx3qMmaaXd07A/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=19)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp3YnaAMiaP2rJZbFxaibFGHjkTZicelYX4wf1UETQMQS2rBZYn79ZJZjrv0nE25AicYibrH7e3W9V7vXv91ic0p0ZGNVLlfPLPXhAibWU/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=20)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp2JRzrY3nHEN70EJiaaEialyPeDChiciaMnAxFyobS6ic7gjEyQSArxd2KfNibTecSor6Pk3PbH0A2MXsIficBts6gDQIvAbia60UFcrSY/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=21)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp0fm7aO8fB4s8y1TIafcxGpOzJ1hEGDLM8ClvunKTyBmYsSMo7iayM7GdX3qbXV8y8eeO2hgISfZjdra0dLGEOkUme4tiaHT3iaSQ/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=22)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_jpg/DthwRd8vvp1xrbhkx7oQQ2o8bd2XYrQZZnQCQxR687ZFIGw8ibH2veVcNZLMZSvuWcEdib79XBJctYJYunuenJTyrPz02o9UscIQSCnd0J904/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=23)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp1zBsicnWEEX1d2cgdsACUkw2U5BT9D9InKtB4zsf7oezYNzMLPwGgwMklcETxfiaRiaja3vLKmAFBFu7teZq1vrpDibppXF9MelxE/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=24)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/33P2FdAnju8PWonAvnSfAGMpeE3YoiaMhkTk8GJa2bw2cicJNGia8eBEBxXGsvONJMibYcMPWCkB41EiaQ0Ihx0yXXQ/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=25)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp3sIhmlyoY7K3WzHHdCyp6cSg5N2hmco3wY9bchCUxWCuBmyDP7dGxF3tBIsp78ia23sqzkKSV2gMysBlmxOsTYRK0K2QXAW2p0/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=26)

  

支持下钻到具体需求列表，查看每个需求的上线状态、关联的 AI 任务实例、会话数和 Token 成本消耗：

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp2Yw6Gz7sG9MTQa87fa3C1rqenZPbNoNmktzH1yMEydXyxyUfjbTX1fgJLe5CV6yChol63TaPibsNxRR0cgibHN8NfxQoqM4GZog/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=27)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/DthwRd8vvp1icVk1Su9aXNU6iarZ6qM3aP8Y0y6nPkXVJRXmdtxwUFmQxILe1E4kLF5pIGhqrJziaFbtV6q62rqiaZwbnXNWIxpPO2tOBPvWjuY/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=28)
...
|---|---|---|
|聚合维度|数据来源|应用场景|
|Task 维度|单次 AI 对话的 Token 消耗|分析单次对话的效率|
|迭代维度|关联到该迭代的所有 Task Token 总和|评估迭代级的 AI 投入|
|需求维度|关联到该需求的所有 Task Token 总和|评估需求级的 AI 成本|
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/DthwRd8vvp2gopZtlm0QLM2N1aKBFZQRkib7VED6A1h7rb7RibxOnlRXWbMRqEkWem3d5XKqaxGLUtNh2iaGia7zOIWa9LsJUibrNwXQQN3kojJQ/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=29)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/33P2FdAnju8PWonAvnSfAGMpeE3YoiaMhiaYDH4qKtXibfuNQofj58j7w9S8icvKz0Gq76dOdD0tfvcNjokfYibbKxQ/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=30)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/33P2FdAnju8PWonAvnSfAGMpeE3YoiaMhZMffic8JnvvLIgyJ9CUGzAiaiciaG61AHjhJSiaA5tmQZRSVFNRf3iabgibww/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=31)
